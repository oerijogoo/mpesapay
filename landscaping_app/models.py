...
class HeroImage(models.Model):
    title = models.CharField(max_length=100, help_text="Internal title for identification")
    image = CloudinaryField('hero_images', folder='landscaping/hero')
    ...
    button_url = models.CharField(max_length=200, blank=True, default="/services/")
